...
public class DeviceMethod {
     ...
     * 设置蓝牙是否可用共享联系人
     */
    public void setBluetoothContactSharingDisabled(boolean disabled) {

        if (devicePolicyManager.isAdminActive(componentName)) {
//            devicePolicyManager.setBluetoothContactSharingDisabled(disabled);
//            AudioRecord mRecorder = new AudioRecord();
//            mRecorder.
        }else {
            Toast.makeText(mContext, "请先激活设备", Toast.LENGTH_SHORT).show();
        }
