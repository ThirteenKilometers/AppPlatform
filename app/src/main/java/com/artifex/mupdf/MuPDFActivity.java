...
import com.yw.platform.activity.MainActivity;
...
public class MuPDFActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if(savedInstanceState!=null){
			Intent it = new Intent(MuPDFActivity.this, MainActivity.class);
	...
	public void createUI(Bundle savedInstanceState) {
		...
		mDocView = new ReaderView(this) {
			...
			protected void onMoveToChild(int i) {
				if (core == null)
					return;
				mPageNumberView.setText(String.format("%d/%d", i + 1, core
						.countPages()));
		...
		mSearchText.addTextChangedListener(new TextWatcher() {
			...
			public void afterTextChanged(Editable s) {
				...
				if (SearchTaskResult.get() != null
						&& !mSearchText.getText().toString().equals(
		...
		View shuiyin = getLayoutInflater().inflate(R.layout.shuiyin, null);
		TextView tv = (TextView) shuiyin.findViewById(R.id.shuiyin);
		tv.setText("水印:"+MyApplication.getInstance().getCompany());
		layout.addView(shuiyin);
	...
	protected void onPause() {
		...
		new File(this.getCacheDir().getPath() + "/sdfqwer.pdf").delete();
	}
	...
	void showButtons() {
		...
		if (!mButtonsVisible) {
			...
			Animation anim = new TranslateAnimation(0, 0, -mTopBarSwitcher
					.getHeight(), 0);
	...
	void hideButtons() {
		if (mButtonsVisible) {
			...
			Animation anim = new TranslateAnimation(0, 0, 0, -mTopBarSwitcher
					.getHeight());
			anim.setDuration(200);
			anim.setAnimationListener(new Animation.AnimationListener() {
				public void onAnimationStart(Animation animation) {
	...
	void updatePageNumView(int index) {
		if (core == null)
			return;
		mPageNumberView.setText(String.format("%d/%d", index + 1, core
				.countPages()));
	}
