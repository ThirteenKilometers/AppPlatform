...
/**
 * 日志相关工具类<br/>
 * 兼容 Android Studio 3.1.0 的 Logcat 完美显示日志<br/>
 * 兼容 Kotlin<br/>
 * 可设置 Log 开启和关闭<br/>
 * 可设置是否输出到控制台（Logcat）<br/>
 * 可设置 Log 全局 Tag<br/>
 * 全局 Tag 为空时 Tag 为当前类名<br/>
 * 可设置 Log 是否显示头部信息<br/>
 * Log 文件顶部显示设备信息<br/>
 * Log 头部含有当前线程名<br/>
 * Log 头部含有当前类及行号和函数名，支持点击跳转<br/>
 * 可设置 Log 是否写入文件<br/>
 * 可设置 Log 写入文件目录<br/>
 * 可设置 Log 写入文件前缀<br/>
 * 可设置 Log 是否显示边框<br/>
 ...
 * 支持 JSON 串的输出<br/>
 * 支持 XML 串的输出<br/>
 * 支持 Live Templates<br/>
 * 作者：LZHS<br/>
 * 时间： 2018/2/6 22:38<br/>
