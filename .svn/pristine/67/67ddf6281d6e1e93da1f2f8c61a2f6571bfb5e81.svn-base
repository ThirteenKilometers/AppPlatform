...
public class NetApi {
    ...
    public static String getReuestId(){
        return System.currentTimeMillis()+"_"+((int)(Math.random()*100));
    }
    ...
    public static void queryAppDownUrl(String requestId,String appId) {
        ...
        event.setMsg("正在向服务器发送：请求apk下载地址");
        event.setData(data);
