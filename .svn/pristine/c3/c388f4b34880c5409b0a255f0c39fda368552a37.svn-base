package com.yw.platform.download;
...
//import com.ttxc.platform.utils.HttpClient;
import java.io.File;
...
public class DownloadManager {
    ...
    public DownloadInfo getDownloadInfo(String appName) {
        for (DownloadInfo downloadInfo : downloadInfoList) {
            if (downloadInfo.getFileName().equalsIgnoreCase(appName)) {
                return downloadInfo;
            }
        }
        return null;
    ...
    public void backupDownloadInfo(DownloadInfo downloadInfo) throws DbException {
        db.saveOrUpdate(downloadInfo);
    }
    ...
    public class ManagerCallBack extends RequestCallBack<File> {
        ...
        public void onCancelled() {
            ...
            try {
                ...
                Log.i("DownloadManager", "onCancelled(),exception");
                LogUtils.e(e.getMessage(), e);
            }
            if (baseCallBack != null) {
        ...
        public void onLoading(long total, long current, boolean isUploading) {
            ...
            try {
                ...
                Log.i("DownloadManager", "onLoading(),exception");
                LogUtils.e(e.getMessage(), e);
            }
            if (baseCallBack != null) {
        ...
        public void onSuccess(ResponseInfo<File> responseInfo) {
            ...
            try {
                ...
                Log.i("DownloadManager", "onSuccess(),exception");
                LogUtils.e(e.getMessage(), e);
            }
            if (baseCallBack != null) {
        ...
        public void onFailure(HttpException error, String msg) {
            ...
            try {
                ...
                Log.i("DownloadManager", "onFailure(),exception");
                LogUtils.e(e.getMessage(), e);
            }
            if (baseCallBack != null) {
