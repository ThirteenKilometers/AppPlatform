...
public final class Const {
     ...
     */
    public final static String METHER_QUERYDOCUMENTPREVIEWURL = "queryDocumentPreviewUrl";
    public final static int METHER_QUERYDOCUMENTPREVIEWURL_CODE = 0xa009;

    /*
     * 接收通知
     */
    public final static String NOTICE_PATH = "noticePush";
    public final static int METHER_NOTICE_PATH_CODE = 0xa0010;
    /**
     *
     */
