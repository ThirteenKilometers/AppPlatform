...
public class FloatPanel extends LinearLayout {
	...
	public static interface OnPanelListener {
		 ...
		 */
		public void onPanelClosed(FloatPanel panel);

		/**
		 * Invoked when the panel becomes fully opened.
		 */
		public void onPanelOpened(FloatPanel panel);
	}
...
//		mContent.setClickable(true);
	...
	private void postProcess() {
		...
		if (panelListener != null) {
			if (mIsShrinking) {
				panelListener.onPanelClosed(FloatPanel.this);
			} else {
				panelListener.onPanelOpened(FloatPanel.this);
			}
		}
	}
